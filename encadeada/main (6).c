...
typedef struct {
    ...
    char saborBolo[50];
    char tamanhoBolo;
    char ingredienteBolo[100];
    char dataFabricacao[20];
...
Bolo* criarBolo() {
    ...
    scanf("%d", novoBolo->nomeBolo);
    printf("\nDigite o sabor do bolo:\n ");
    scanf("%d", novoBolo->saborBolo);
    printf("\nDigite o tamanho do bolo (P, M ou G):\n ");
    scanf(" %c", &novoBolo->tamanhoBolo);
    printf("\nDigite os ingredientes do bolo:\n ");
    scanf("%s", novoBolo->ingredienteBolo);
    printf("\nDigite a data de fabricacao do bolo:\n ");
    scanf("%s", novoBolo->dataFabricacao);
